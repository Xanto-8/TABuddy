          ...
          <div className="flex flex-col items-start w-full px-8 lg:pl-16 lg:pr-4">
            ...
            <div className="mt-10 flex items-center gap-4">
              <button
                ...
                className="rounded-md border border-white px-10 py-4 text-xl font-bold text-white transition-colors hover:bg-white hover:text-black"
              >
                进入系统
              </button>
              <button
                onClick={() => window.open('https://share.feijipan.com/s/B64lr1zG', '_blank')}
