      ...
      <div className="w-full max-w-md mx-4 rounded-2xl border border-border bg-card shadow-2xl overflow-hidden">
        ...
        {step === 'success' && (
          <div className="px-6 py-8 flex flex-col items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-stone-100 dark:bg-orange-900/30 flex items-center justify-center">
              <CheckCircle className="w-8 h-8 text-stone-600 dark:text-orange-300" />
            </div>
