                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={cn(
                    ...
                    user?.role === 'superadmin'
                      ? 'bg-amber-100 text-amber-700 dark:bg-orange-900/30 dark:text-orange-300 border-amber-200 dark:border-orange-800'
                      : 'bg-blue-100 text-blue-700 dark:bg-orange-900/30 dark:text-orange-300 border-blue-200 dark:border-orange-800'
                  )}>
